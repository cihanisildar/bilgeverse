                ...
                >
                  ...
                  <div className="relative z-10 p-6 h-full flex flex-col">
                    ...
                    >
                      ...
                      <span className="text-white font-semibold">+{card.points} puan</span>
                    </motion.div>

                    {/* Hover instruction */}
                    <motion.div
                      className="mt-3 flex items-center justify-center gap-2 text-purple-300 text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                      animate={hoveredCard === card.id ? { y: [0, -2, 0] } : {}}
              ...
              <div className="relative z-10 p-8 sm:p-12">
                <div className="text-center space-y-6">
                  ...
                  >
                    ...
                    <span className="text-white font-bold text-lg">+{selectedCard.points} puan</span>
                  </motion.div>
