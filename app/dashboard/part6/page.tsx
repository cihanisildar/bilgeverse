...
export default async function Part6Page() {
  // Session check is handled by Part6Layout
        ...
        <Card className="border-0 shadow-lg rounded-2xl overflow-hidden">
          ...
          <CardContent>
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">Sosyal medya yönetim sistemi üzerinde çalışıyoruz.</p>
              <p className="text-sm text-gray-500">Bu bölüm tamamlandığında içerik planlaması, gönderi takibi ve analitik özellikleri sunacaktır.</p>
            </div>
          </CardContent>
        </Card>
      </div>
