...
import { EventCardSkeleton, HeaderSkeleton, SearchFilterSkeleton } from '@/app/components/ui/skeleton-shimmer';
        ...
        <div className="px-4 py-16">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button
                onClick={() => router.push('/dashboard/part7/admin/events/event-types')}
                size="lg"
                variant="outline"
