...
export default function StudentDashboard() {
  ...
  const loading = userLoading || leaderboardLoading || eventsLoading || pointsLoading || requestsLoading || meetingsLoading;
                ...
                {recentPoints.map((transaction) => (
                  <div key={transaction.id} className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      <div className={`h-8 w-8 sm:h-10 sm:w-10 rounded-full flex items-center justify-center ${transaction.type === 'AWARD' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
                        }`}>
                    ...
                    <div className={`text-sm sm:text-base font-semibold ${transaction.type === 'AWARD' ? 'text-green-600' : 'text-red-600'
                      }`}>
