...
export default function EditEvent() {
  ...
  const onSubmit = async (data: EventFormValues) => {
    try {
      ...
      router.push(`/dashboard/part7/tutor/events/${eventId}`);
    } catch (err: any) {
      toast({
        variant: "destructive",
        title: "Hata",
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-red-700">
            ...
            <Button
              variant="outline"
              className="mt-4"
              onClick={() => router.push('/dashboard/part7/tutor/events')}
            >
              Etkinliklere Dön
            </Button>
          </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="flex justify-end gap-4">
              <Button
                type="button"
                variant="outline"
                onClick={() => router.push(`/dashboard/part7/tutor/events/${eventId}`)}
              >
                İptal
              </Button>
