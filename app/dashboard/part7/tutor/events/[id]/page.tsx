...
export default function EventDetails() {
  ...
  const handleDeleteEvent = async () => {
    try {
      ...
      setTimeout(() => {
        router.push('/dashboard/part7/tutor/events');
      }, 1000);
    } catch (error: any) {
          ...
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              {user && event.createdBy.id === user.id && (
                <>
                  <Button
                    ...
                    asChild
                  >
                    <Link href={`/dashboard/part7/tutor/events/${event.id}/edit`}>
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href={`/dashboard/part7/tutor/events/${event.id}/share`}>
              ...
              <Button
                ...
                asChild
              >
                <Link href={`/dashboard/part7/tutor/events/${event.id}/participants`}>
