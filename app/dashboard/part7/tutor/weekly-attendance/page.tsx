...
import AttendanceSessionsList from '@/app/dashboard/part2/attendance/AttendanceSessionsList';
import AttendanceHeaderButtons from '@/app/dashboard/part2/attendance/AttendanceHeaderButtons';
...
export default function TutorWeeklyAttendancePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 p-4 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <Link href="/dashboard/part7/tutor/attendance">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-gray-600">Tarih oluşturarak geçmiş veya telafi yoklamaları alın</p>
            </div>
