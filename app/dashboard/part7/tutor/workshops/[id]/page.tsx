...
import { ArrowLeft, Calendar, Users, Briefcase, List, UserCircle2, ShieldCheck } from 'lucide-react';
...
export default async function TutorWorkshopDetailsPage({ params }: { params: { id: string } }) {
    const session = await requireAuth({ partId: 4 });

    const workshop = await getWorkshopById(params.id);

    if (!workshop) {
        redirect('/dashboard/part7/tutor/workshops');
    }
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
                <Link href="/dashboard/part7/tutor/workshops">
